...
static const char primary[]         = "#458588";
static const char accent[]          = "#83A598";
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_gray3, background, accent },
	[SchemeSel]  = { col_gray4, primary,  primary  },
};
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", background, "-nf", col_gray3, "-sb", primary, "-sf", col_gray4, NULL };
